    ...
    <div class="navbar-inner">
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                    <ul>
                        <li class="span3">
                            <a href="<c:url value="/" />" style="text-align: left; color: white">
                                <h4 style="text-align: left;">HomeDW</h4>
                            </a>
                        </li>
                        <li class="span5">
                        ...
                        <li class="span3">
                            <a href="<c:url value="/admin" />" style="text-align: right;">
    ...
    <div class="my_page-header">
        ...
        <div class="row">
            ...
            <div class="span2">
                ...
                <%--  <img src="<c:url value="/resources/img/estradasdeportugalkt8.png"/> --%>
            </div>
            <div class="span10">
            ...
            <div class="span12" style="margin-top: 20px;">
                <div class="tabbable tabs">
                    ...
                    <ul class="nav my_nav-tabs">
                        ...
                        <li class="active"><a href="<c:url value="#DW" />"
                                              data-toggle="tab">DW</a></li>
                        ...
                        <c:forEach items="${menuList}" var="menu">
                            ...
                            <li><a href="<c:url value="#${menu.id_menu}" />"
                                   data-toggle="tab">${menu.item_menu}</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active" id="DW">
                            ...
                            <p>O Data Warehouse das Estradas de Portugal, S.A. pretende
                                ser uma plataforma que centraliza, por área, dados
                                operacionais. Aplicando as melhores práticas conhecidas na
                                indústria, recolhe, valida, uniformiza, agrega e disponibiliza
                                informação sob vários formatos. O produto final será informação
                                estratégica de qualidade.</p>
                            <%--<p><a href="#" class="btn btn-success btn-small" style="color:#fff">Saber mais &raquo;</a></p>--%>
                            <p>
                                <a href="<c:url value="#" />" class="btn btn-success btn-small"
                                   style="color: #fff">Saber mais &raquo;</a>
                            </p>
                        </div>
                            ...
                            <div class="tab-pane fade" id="${menu.id_menu}">
                                ...
                                <p>
                                    <a href="<c:url value="${menu.url}" />"
                                       class="btn btn-success btn-small" style="color: #fff">Saber
                                        mais &raquo;</a>
                                </p>
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <ul class="thumbnails">
                ...
                <li><a href="#"
                       class="thumbnail"> <%--  <img src="/resources/img/dashbord.png" alt="Dashbord" title="Dashbord">--%>
                    <img src="<c:url value="/resources/img/dashbord.png"/> "
                         alt="Dashbord" title="Dashbord">

                </a>
                    <h5 style="text-align: center;">Dashbord</h5></li>

                <li><a href="#" class="thumbnail"> <img
                        src="<c:url value="/resources/img/relatorio.png"/> "
                        alt="Relatorios"
                        title="Relatorios"> <%-- <img src="../../resources/img/relatorio.png" alt="Relatorios" title="Relatorios">--%>
                </a>
                    <h5 style="text-align: center;">Relatorios</h5></li>

                <li><a href="#" class="thumbnail"> <img
                        src="<c:url value="/resources/img/contactos.png"/> "
                        alt="Contacto"
                        title="Contacto"> <%--<img src="../../resources/img/contactos.png" alt="Contacto" title="Contactos">--%>
                </a>
                    <h5 style="text-align: center;">Contactos</h5></li>

                <li><a href="#" class="thumbnail"> <img
                        src="<c:url value="/resources/img/sugestao.png"/> "
                        alt="Susgestões"
                        title="Susgestões"> <%-- <img src="../../resources/img/sugestao.png" alt="Susgestões" title="Sugestões">--%>
                </a>
                    <h5 style="text-align: center;">Sugestões</h5></li>

                <li><a href="#" class="thumbnail"> <img
                        src="<c:url value="/resources/img/esclarecimento_2.png"/> "
                        alt="Esclarecimentos"
                        title="Esclarecimentos"> <%--<img src="../../resources/img/esclarecimento_2.png" alt="Esclarecimentos" title="Esclarecimentos">--%>
                </a>
                    <h5 style="text-align: center;">Informações</h5></li>
            ...
            <table class="table">
                ...
                <c:forEach items="${noticiaList}" var="noticia">
                    <tr>
                        ...
                        <td style="font-size: 13px"><a class="fancybox"
                                                       href="<c:url value="#p${noticia.id_noticia}" />">${noticia.titulo_noticia}</a>
                        </td>
