...
<html>
    ...
    <body>
        ...
        <div class="container"><%-- 2º container --%>  
            ...
            <form:form action="/homedw/admin/editItem/${id_menu}" method="PUT" commandName="menu" id="form">
                <table width=80% align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="submit" name="action" class="btn btn-success" value="edit" id="edit">Guardar</button>  
