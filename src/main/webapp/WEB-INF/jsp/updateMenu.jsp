...
<div class="container"><%-- 2º container --%>
    ...
    <form:form action="/estrdasDW/admin/editNoticia/${id_noticia}" method="PUT" commandName="noticia">
        <table width=80% align="right">
            ...
            <tr>
                ...
                <form:errors path="id_noticia"></form:errors>
            </tr>
            <tr>
                ...
                <form:errors path="titulo_noticia"></form:errors>
            </tr>
            <tr>
                ...
                <form:errors path="descricao_noticia"></form:errors>
            </tr>
            <tr>
                ...
                <form:errors path="data_noticia"></form:errors>
            </tr>
            <tr>
                <td>
                <td>
